...
parser MyParser(packet_in packet,
    ...
    state start {
        packet.extract(hdr.dissaggregation_header); // Parsing the new header
...
control MyIngress(inout headers hdr,
    ...
    apply {
      meta.port = hdr.dissaggregation_header.port; // Copy the data into the original metadata field  		
      ipv4_lpm2.apply();
