...
header gtpv1_extension_hdr_t {
    ...
    // CHANGE: This does not change control flow, but uncommenting  would make packets very long
    //    varbit<128> contents;
    bit<8> nextExtHdrType;
}
...
control ingress(inout headers hdr,
    ...
    action forward(PortId_t port) {
        standard_metadata.egress_port = (PortId_t)(port);
        hdr.ethernet.srcAddr = OWN_MAC;
    }

    action bcast() {
        standard_metadata.egress_port = (PortId_t)(9w100);
    }
    ...
    apply {
        ...
        // CHANGE: This is needed, otherwise P4Testgen crashes due to taint.
...
control DeparserImpl(packet_out packet,
    ...
    apply {
        ...
        // CHANGE: These are not parsed by the parser. They are causing taint errors in P4Testgen.
